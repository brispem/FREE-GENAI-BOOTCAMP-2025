class MadridPenaltyScene extends Phaser.Scene {
    constructor() {
        super({ key: SceneKeys.MADRID_PENALTY });
        this.state = 'SETUP';
    ...
    preload() {
        this.load.image('madrid_penalty_bg', 'images/madrid_penalty.png');
    ...
    create() {
        console.log('MadridPenaltyScene created');
        ...
        // Set up background
        const bg = this.add.image(400, 300, 'madrid_penalty_bg');
    ...
    showResult(isGoal) {
        ...
        const spaceKey = this.input.keyboard.addKey('SPACE');
        spaceKey.once('down', () => {
            this.scene.start(isGoal ? SceneKeys.REACH_FINAL : SceneKeys.MISS);
        });
