...
def search_web_serp(query: str, max_results: int = 5) -> List[Dict[str, str]]:
    """
    Search the web for Spanishsong lyrics using SERP API.
    ...
    # Change Japanese-specific keywords to Spanish
    ...
    try:
        ...
        params = {
            ...
            "gl": "es",  # Results from Spanish-speaking regions
            "api_key": api_key
        }
